environment_name         = "dynamictf"
environment_abbreviation = "dtf"
namespace                = "dynamictf"
authors                  = "mwermuth"
owners                   = "mwermuth"
project                  = "dynamictf"
...
ecs_data = {
  "dynamic" = {
    ...
    task_definition = [
      {
        family                   = "dynamictf-node-test"
        requires_compatibilities = ["FARGATE"]
        network_mode             = "awsvpc"
        cpu                      = 1024
        memory                   = 2048
        container_definitions = {
          name      = "dynamictf-node-test"
          essential = true
          portMappings = {
    ...
    service = [
      {
        ...
        task_definition_name = "dynamictf-node-test"
        ...
        create_service_connect   = true

        load_balancer = {
          container_name = "dynamictf-node-test"
          container_port = 3000
        }
...
eks_data = {
  "dynamic-cluster" = {
    ...
    instance_types_default = ["m5.small"]
...
cloudfront_data = {
  ...
  ipv6_enabled           = true
  certificate_arn        = ""
  alternate_domain_names = "dynamictf.com"
